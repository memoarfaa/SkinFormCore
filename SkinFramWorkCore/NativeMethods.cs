...
namespace SkinFramWorkCore
{
    public partial class NativeMethods
    {
        ...
        public enum WindowsMessages : uint
        {
            ...
            NCMOUSELEAVE = 0x02A2,
            /// <summary>
            /// The WM_NCMOUSELEAVEDWM message is posted to a window when the cursor leaves the nonclient area of the window specified in a prior call to TrackMouseEvent and Dwm is Enabled.
            /// </summary>
            NCMOUSELEAVEDWM = 0x2a2,
            /// <summary>
        ...
        public struct RECT
        {
            ...
            public RECT GetRtlRect(int width)
            {
        ...
        public static extern int BufferedPaintClear(IntPtr hBufferedPaint, ref RECT prc);
        [DllImport("uxtheme.dll", EntryPoint = "BufferedPaintClear")]
        public static extern int BufferedPaintClear(IntPtr hBufferedPaint, IntPtr prc);
        [DllImport("uxtheme.dll")]
        public static extern IntPtr EndBufferedPaint(IntPtr hBufferedPaint, bool fUpdateTarget);
        [DllImport("uxtheme.dll")]
        public static extern int BufferedPaintSetAlpha(IntPtr hBufferedPaint, [In] ref RECT prc, byte alpha);


        [DllImport("uxtheme", ExactSpelling = true)]
        public extern static int GetThemeRect(IntPtr hTheme, int iPartId, int iStateId, int iPropId, out RECT pRect);
        ...
        [DllImport("dwmapi.dll", CharSet = CharSet.Auto, ExactSpelling = false)]
